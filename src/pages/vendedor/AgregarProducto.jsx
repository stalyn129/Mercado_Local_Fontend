...
export default function AgregarProducto() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // ✅ PASO 1 - Subir imagen a Cloudinary usando el nuevo endpoint
      console.log("📤 Subiendo imagen a Cloudinary...");
      console.log("🔗 Endpoint:", `${API_URL}/productos/subir-imagen`);
      ...
      console.log("🖼️ URL de Cloudinary:", cloudinaryUrl);

      // ✅ PASO 2 - Crear el producto con la URL de Cloudinary
  ...
  // Análisis automático de precio cuando cambian los campos
  useEffect(() => {
                            ...
                            <div style={{
                              ...
                              <div>
                                ...
                                <p style={{
                                  ...
                                  {precioIA.consejo || `Los huevos no se venden por ${form.unidad}. Usa '${precioIA.unidad_sugerida}'`}
                                </p>
                              </div>
                            </div>
