...
export default function PedidoDetalle() {
  ...
  // LÍNEA DE TIEMPO MEJORADA - Usando la funcionalidad del segundo código
  ...
  // Validación del formulario - Manteniendo la funcionalidad del segundo código
    ...
    <div style={{
      ...
      <div style={{
        ...
        {!mostrarVistaCheckout ? (
          ...
          /* VISTA CHECKOUT - Usando la funcionalidad del segundo código pero con diseño naranja */
          <div style={{
            display: "grid",
            gridTemplateColumns: "1fr 400px",
            gap: "30px",
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                ...
                {metodoPago === "EFECTIVO" && (
                  <div>
                    ...
                    <label style={{
                      ...
                      marginBottom: "6px",
                      fontSize: "13px",
                    }}>Monto que entregarás (opcional):</label>
                    <input
                      type="number"
                      step="0.01"
                      value={montoEfectivo}
              ...
              <button
                ...
                style={{
                  width: "100%",
                  background: finalizando ? "#94a3b8" : "#FF6B35",
                  color: "white",
                  padding: "18px",
                  fontSize: "17px",
                  fontWeight: "700",
                  ...
                  transition: "all 0.3s ease",
                  fontFamily: "'Inter', sans-serif",
                  boxShadow: finalizando ? "none" : "0 6px 20px rgba(255, 107, 53, 0.4)"
                }}
                onMouseEnter={(e) => {
                  if (!finalizando) {
                    e.currentTarget.style.transform = "translateY(-3px)";
                    e.currentTarget.style.boxShadow = "0 10px 25px rgba(255, 107, 53, 0.6)";
                  }
                }}
                onMouseLeave={(e) => {
                  if (!finalizando) {
